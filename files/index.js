...
const port = process.env.SERVER_PORT || process.env.PORT || 4007;        
const UUID = process.env.UUID || '55502e51-f370-4302-9171-dfd5820c5763'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'chaotwo.clisaxlo.eu.org';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiMDk0OTIxZDhmY2JmMWI1ODk4NjVmMDhhNDAxYzBhZGUiLCJ0IjoiYWEzMzZhZjMtYTJkZS00ZDIwLWJkY2EtMDQwOWMxNGFlM2Y3IiwicyI6Ik5ESXpNakUzTUdZdFpEaGtZaTAwWlRCbUxUaGpZemd0WldRd1pUQTRNRFV3T1RGbCJ9';
const CFIP = process.env.CFIP || 'na.ma';
const NAME = process.env.NAME || 'Caster';
